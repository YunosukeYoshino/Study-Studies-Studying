...
import * as Validatable from "../util/validation"; // グループ化 エイリアス(別名をつけることができる！)
import { autobind as Autobind } from "../decorators/autoBind"; //名前をつけることによって似たような名前を避けるメリットがある。
